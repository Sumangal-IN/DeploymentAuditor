...
public class ExcelReportDataOrganizerTest {
	...
	public void setUp() throws Exception {
		...
		InstanceOfPTier.add(new Instance("P", "PIIBINST1", "unxs0616.gha.kfplc.com"));
		InstanceOfPTier.add(new Instance("P", "PIIBINST2", "unxs0617.gha.kfplc.com"));
		InstanceOfPTier.add(new Instance("P", "PIIBINST3", "unxs0622.gha.kfplc.com"));
		InstanceOfPTier.add(new Instance("P", "PIIBINST4", "unxs0623.gha.kfplc.com"));
		InstanceOfVTier.add(new Instance("V", "VIIBINST1", "unxs0624.gha.kfplc.com"));
		InstanceOfVTier.add(new Instance("V", "VIIBINST2", "unxs0625.gha.kfplc.com"));
		InstanceOfVTier.add(new Instance("V", "VIIBINST3", "unxs0630.gha.kfplc.com"));
		InstanceOfVTier.add(new Instance("V", "VIIBINST4", "unxs0631.gha.kfplc.com"));
		InstanceOfQTier.add(new Instance("Q", "QIIBINST1", "unxs0634.ghanp.kfplc.com"));
		InstanceOfQTier.add(new Instance("Q", "QIIBINST2", "unxs0707.ghanp.kfplc.com"));
		InstanceOfETier.add(new Instance("E", "EIIBINST1", "unxs0612.ghanp.kfplc.com"));
		InstanceOfFTier.add(new Instance("F", "FIIBINST1", "unxs0614.ghanp.kfplc.com"));
